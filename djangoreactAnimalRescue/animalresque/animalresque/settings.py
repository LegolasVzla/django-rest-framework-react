"""
Django settings for animalresque project.
...
SECRET_KEY = '3(j=pl00kjt%y9dh8+e0y*scqq#=04rlzl5&@8yo__23+hqz1b'
...
ROOT_URLCONF = 'animalresque.urls'
...
WSGI_APPLICATION = 'animalresque.wsgi.application'
